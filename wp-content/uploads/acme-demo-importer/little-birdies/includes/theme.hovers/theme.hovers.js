...
jQuery(document).on('action.init_hidden_elements', function(e, cont) {
	"use strict";
	if (LITTLE_BIRDIES_STORAGE['button_hover'] && LITTLE_BIRDIES_STORAGE['button_hover']!='default') {
		jQuery('button:not(.search_submit):not([class*="sc_button_hover_"]),\
				...
				.little_birdies_tabs .little_birdies_tabs_titles li a:not([class*="sc_button_hover_"]),\
				...
				').addClass('sc_button_hover_just_init sc_button_hover_'+LITTLE_BIRDIES_STORAGE['button_hover']);
		if (LITTLE_BIRDIES_STORAGE['button_hover']!='arrow') {
		...
		jQuery('.sidebar .trx_addons_tabs .trx_addons_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
				.little_birdies_tabs .little_birdies_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
				.widget_tag_cloud a:not([class*="sc_button_hover_style_"]),\
				.widget_product_tag_cloud a:not([class*="sc_button_hover_style_"])\
				').addClass('sc_button_hover_just_init sc_button_hover_style_alterbd');
        jQuery('.sc_button_yellow_button,\
                #tribe-bar-views .tribe-bar-views-list .tribe-bar-views-option a,\
                .tribe-bar-mini #tribe-bar-views .tribe-bar-views-list .tribe-bar-views-option a\
				').addClass('sc_button_hover_just_init sc_button_hover_style_yellow');

		jQuery('.vc_tta-accordion:not(.vc_tta-color-white) .vc_tta-panel-heading .vc_tta-panel-title:not([class*="sc_button_hover_style_"]),\
        ...
        jQuery('.vc_tta-accordion.vc_tta-color-white .vc_tta-panel-heading .vc_tta-panel-title:not([class*="sc_button_hover_style_"])\
		...
		jQuery('.mejs-controls button,\
				...
				').removeClass('sc_button_hover_'+LITTLE_BIRDIES_STORAGE['button_hover']);

        // Remove class hover_xxx
        jQuery('.pswp__button').removeClass('sc_button_hover_'+LITTLE_BIRDIES_STORAGE['button_hover']);
