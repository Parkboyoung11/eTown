...
if (!function_exists('little_birdies_trx_addons_theme_setup1')) {
	add_action( 'after_setup_theme', 'little_birdies_trx_addons_theme_setup1', 1 );
	add_action( 'trx_addons_action_save_options', 'little_birdies_trx_addons_theme_setup1', 8 );
	function little_birdies_trx_addons_theme_setup1() {
		if (little_birdies_exists_trx_addons()) {
			add_filter( 'little_birdies_filter_list_posts_types',	'little_birdies_trx_addons_list_post_types');
			add_filter( 'little_birdies_filter_list_header_styles','little_birdies_trx_addons_list_header_styles');
			add_filter( 'little_birdies_filter_list_footer_styles','little_birdies_trx_addons_list_footer_styles');
		}
	}
}
...
if (!function_exists('little_birdies_trx_addons_theme_setup9')) {
	add_action( 'after_setup_theme', 'little_birdies_trx_addons_theme_setup9', 9 );
	function little_birdies_trx_addons_theme_setup9() {
		if (little_birdies_exists_trx_addons()) {
			add_filter( 'trx_addons_sc_atts',							'little_birdies_trx_addons_sc_atts', 10, 2);
			add_filter( 'trx_addons_sc_output',							'little_birdies_trx_addons_sc_output', 10, 4);
			add_filter( 'trx_addons_filter_featured_image',				'little_birdies_trx_addons_featured_image', 10, 2);
			add_filter( 'trx_addons_filter_no_image',					'little_birdies_trx_addons_no_image' );
			add_filter( 'trx_addons_filter_get_list_icons',				'little_birdies_trx_addons_get_list_icons', 10, 2 );
			add_filter( 'trx_addons_filter_slider_title',				'little_birdies_trx_addons_slider_title', 10, 2 );
			add_filter( 'trx_addons_filter_meta_box_fields',			'little_birdies_trx_addons_meta_box_fields', 10, 2);
			add_action( 'wp_enqueue_scripts', 							'little_birdies_trx_addons_frontend_scripts', 1100 );
			add_filter( 'little_birdies_filter_query_sort_order',	 			'little_birdies_trx_addons_query_sort_order', 10, 3);
			add_filter( 'little_birdies_filter_merge_scripts',					'little_birdies_trx_addons_merge_scripts');
			add_filter( 'little_birdies_filter_get_css',						'little_birdies_trx_addons_get_css', 10, 4);
			add_filter( 'little_birdies_filter_prepare_css',					'little_birdies_trx_addons_prepare_css', 10, 2);
			add_filter( 'little_birdies_filter_prepare_js',					'little_birdies_trx_addons_prepare_js', 10, 2);
			add_filter( 'little_birdies_filter_get_post_categories',		 	'little_birdies_trx_addons_get_post_categories');
			add_filter( 'little_birdies_filter_get_post_date',		 			'little_birdies_trx_addons_get_post_date');
			add_filter( 'trx_addons_filter_get_post_date',		 		'little_birdies_trx_addons_get_post_date_wrap');
			add_filter( 'little_birdies_filter_post_type_taxonomy',			'little_birdies_trx_addons_post_type_taxonomy', 10, 2 );
			if (is_admin()) {
				add_filter( 'little_birdies_filter_allow_meta_box', 			'little_birdies_trx_addons_allow_meta_box', 10, 2);
				add_filter( 'little_birdies_filter_allow_theme_icons', 		'little_birdies_trx_addons_allow_theme_icons', 10, 2);
				add_filter( 'trx_addons_sc_map',						'little_birdies_trx_addons_sc_map', 10, 2);
			} else {
				add_filter( 'trx_addons_filter_theme_logo',				'little_birdies_trx_addons_theme_logo');
				add_filter( 'trx_addons_filter_post_meta',				'little_birdies_trx_addons_post_meta', 10, 2);
				add_filter( 'little_birdies_filter_get_mobile_menu',			'little_birdies_trx_addons_get_mobile_menu');
				add_filter( 'little_birdies_filter_detect_blog_mode',			'little_birdies_trx_addons_detect_blog_mode' );
				add_filter( 'little_birdies_filter_get_blog_title', 			'little_birdies_trx_addons_get_blog_title');
				add_action( 'little_birdies_action_login',						'little_birdies_trx_addons_action_login', 10, 2);
				add_action( 'little_birdies_action_search',					'little_birdies_trx_addons_action_search', 10, 3);
				add_action( 'little_birdies_action_breadcrumbs',				'little_birdies_trx_addons_action_breadcrumbs');
				add_action( 'little_birdies_action_show_layout',				'little_birdies_trx_addons_action_show_layout', 10, 1);
			}
		}
		
		// Add this filter any time: if plugin exists - load plugin's styles, if not exists - load layouts.css instead plugin's styles
		add_filter( 'little_birdies_filter_merge_styles',						'little_birdies_trx_addons_merge_styles');
		
		if (is_admin()) {
			add_filter( 'little_birdies_filter_tgmpa_required_plugins',		'little_birdies_trx_addons_tgmpa_required_plugins' );
			add_action( 'admin_enqueue_scripts', 						'little_birdies_trx_addons_editor_load_scripts_admin');
		}
	}
}

// Filter to add in the required plugins list
if ( !function_exists( 'little_birdies_trx_addons_tgmpa_required_plugins' ) ) {
	//Handler of the add_filter('little_birdies_filter_tgmpa_required_plugins',	'little_birdies_trx_addons_tgmpa_required_plugins');
	function little_birdies_trx_addons_tgmpa_required_plugins($list=array()) {
		if (in_array('trx_addons', little_birdies_storage_get('required_plugins'))) {
			$path = little_birdies_get_file_dir('plugins/trx_addons/trx_addons.zip');
			$list[] = array(
					'name' 		=> esc_html__('ThemeREX Addons', 'little-birdies'),
					'slug' 		=> 'trx_addons',
					'version'	=> '1.6.15',
...
if ( !function_exists( 'little_birdies_exists_trx_addons' ) ) {
	function little_birdies_exists_trx_addons() {
		return defined('TRX_ADDONS_VERSION');
	}
}

// Return true if team is supported
if ( !function_exists( 'little_birdies_exists_team' ) ) {
	function little_birdies_exists_team() {
		return defined('TRX_ADDONS_CPT_TEAM_PT');
	}
}

// Return true if services is supported
if ( !function_exists( 'little_birdies_exists_services' ) ) {
	function little_birdies_exists_services() {
		return defined('TRX_ADDONS_CPT_SERVICES_PT');
	}
}

// Return true if portfolio is supported
if ( !function_exists( 'little_birdies_exists_portfolio' ) ) {
	function little_birdies_exists_portfolio() {
		return defined('TRX_ADDONS_CPT_PORTFOLIO_PT');
	}
}

// Return true if courses is supported
if ( !function_exists( 'little_birdies_exists_courses' ) ) {
	function little_birdies_exists_courses() {
		return defined('TRX_ADDONS_CPT_COURSES_PT');
	}
}

// Return true if layouts is supported
if ( !function_exists( 'little_birdies_exists_layouts' ) ) {
	function little_birdies_exists_layouts() {
		return defined('TRX_ADDONS_CPT_LAYOUTS_PT');
	}
}

// Return true if dishes is supported
if ( !function_exists( 'little_birdies_exists_dishes' ) ) {
	function little_birdies_exists_dishes() {
		return defined('TRX_ADDONS_CPT_DISHES_PT');
	}
}

// Return true if it's team page
if ( !function_exists( 'little_birdies_is_team_page' ) ) {
	function little_birdies_is_team_page() {
		return defined('TRX_ADDONS_CPT_TEAM_PT') 
					&& !is_search()
					&& (
...
if ( !function_exists( 'little_birdies_is_services_page' ) ) {
	function little_birdies_is_services_page() {
		return defined('TRX_ADDONS_CPT_SERVICES_PT') 
					&& !is_search()
					&& (
...
if ( !function_exists( 'little_birdies_is_portfolio_page' ) ) {
	function little_birdies_is_portfolio_page() {
		return defined('TRX_ADDONS_CPT_PORTFOLIO_PT') 
					&& !is_search()
					&& (
...
if ( !function_exists( 'little_birdies_is_courses_page' ) ) {
	function little_birdies_is_courses_page() {
		return defined('TRX_ADDONS_CPT_COURSES_PT') 
					&& !is_search()
					&& (
...
if ( !function_exists( 'little_birdies_is_dishes_page' ) ) {
	function little_birdies_is_dishes_page() {
		return defined('TRX_ADDONS_CPT_DISHES_PT') 
					&& !is_search()
					&& (
...
if ( !function_exists( 'little_birdies_trx_addons_frontend_scripts' ) ) {
	//Handler of the add_action( 'wp_enqueue_scripts', 'little_birdies_trx_addons_frontend_scripts', 1100 );
	function little_birdies_trx_addons_frontend_scripts() {
		if (little_birdies_exists_trx_addons()) {
			if (little_birdies_is_on(little_birdies_get_theme_option('debug_mode')) && file_exists(little_birdies_get_file_dir('plugins/trx_addons/trx_addons.css'))) {
				wp_enqueue_style( 'little_birdies-trx_addons',  little_birdies_get_file_url('plugins/trx_addons/trx_addons.css'), array(), null );
				wp_enqueue_style( 'little_birdies-trx_addons_editor',  little_birdies_get_file_url('plugins/trx_addons/trx_addons.editor.css'), array(), null );
			}
			if (little_birdies_is_on(little_birdies_get_theme_option('debug_mode')) && file_exists(little_birdies_get_file_dir('plugins/trx_addons/trx_addons.js')))
				wp_enqueue_script( 'little_birdies-trx_addons', little_birdies_get_file_url('plugins/trx_addons/trx_addons.js'), array('jquery'), null, true );
		} else {
			// Load custom layouts from the theme if plugin not exists
			if ( little_birdies_is_on(little_birdies_get_theme_option('debug_mode')) ) {
				wp_enqueue_style( 'little_birdies-layouts', little_birdies_get_file_url('plugins/trx_addons/layouts/layouts.css') );
				wp_enqueue_style( 'little_birdies-layouts', little_birdies_get_file_url('plugins/trx_addons/layouts/logo.css') );
				wp_enqueue_style( 'little_birdies-layouts', little_birdies_get_file_url('plugins/trx_addons/layouts/menu.css') );
				wp_enqueue_style( 'little_birdies-layouts', little_birdies_get_file_url('plugins/trx_addons/layouts/search.css') );
				wp_enqueue_style( 'little_birdies-layouts', little_birdies_get_file_url('plugins/trx_addons/layouts/title.css') );
				wp_enqueue_style( 'little_birdies-layouts', little_birdies_get_file_url('plugins/trx_addons/layouts/featured.css') );
			}
		}
	}
}
...
// Merge custom styles
if ( !function_exists( 'little_birdies_trx_addons_merge_styles' ) ) {
	//Handler of the add_filter( 'little_birdies_filter_merge_styles', 'little_birdies_trx_addons_merge_styles');
	function little_birdies_trx_addons_merge_styles($list) {
...
if ( !function_exists( 'little_birdies_trx_addons_merge_scripts' ) ) {
	//Handler of the add_filter('little_birdies_filter_merge_scripts', 'little_birdies_trx_addons_merge_scripts');
	function little_birdies_trx_addons_merge_scripts($list) {
...
if ( !function_exists( 'little_birdies_trx_addons_detect_blog_mode' ) ) {
	//Handler of the add_filter( 'little_birdies_filter_detect_blog_mode', 'little_birdies_trx_addons_detect_blog_mode' );
	function little_birdies_trx_addons_detect_blog_mode($mode='') {
		if ( little_birdies_is_team_page() )
			$mode = 'team';
		else if ( little_birdies_is_services_page() )
			$mode = 'services';
		else if ( little_birdies_is_portfolio_page() )
			$mode = 'portfolio';
		else if ( little_birdies_is_courses_page() )
			$mode = 'courses';
		else if ( little_birdies_is_dishes_page() )
			$mode = 'dishes';
		return $mode;
	}
}
...
if ( !function_exists( 'little_birdies_trx_addons_list_post_types' ) ) {
	//Handler of the add_filter( 'little_birdies_filter_list_posts_types', 'little_birdies_trx_addons_list_post_types');
	function little_birdies_trx_addons_list_post_types($list=array()) {
...
if ( !function_exists( 'little_birdies_trx_addons_post_type_taxonomy' ) ) {
	//Handler of the add_filter( 'little_birdies_filter_post_type_taxonomy',	'little_birdies_trx_addons_post_type_taxonomy', 10, 2 );
	function little_birdies_trx_addons_post_type_taxonomy($tax='', $post_type='') {
...
if ( !function_exists( 'little_birdies_trx_addons_get_post_categories' ) ) {
	//Handler of the add_filter( 'little_birdies_filter_get_post_categories', 		'little_birdies_trx_addons_get_post_categories');
	function little_birdies_trx_addons_get_post_categories($cats='') {

		if ( defined('TRX_ADDONS_CPT_TEAM_PT') ) {
			if (get_post_type()==TRX_ADDONS_CPT_TEAM_PT) {
				$cats = little_birdies_get_post_terms(', ', get_the_ID(), TRX_ADDONS_CPT_TEAM_TAXONOMY);
			}
		}
		if ( defined('TRX_ADDONS_CPT_SERVICES_PT') ) {
			if (get_post_type()==TRX_ADDONS_CPT_SERVICES_PT) {
				$cats = little_birdies_get_post_terms(', ', get_the_ID(), TRX_ADDONS_CPT_SERVICES_TAXONOMY);
			}
		}
		if ( defined('TRX_ADDONS_CPT_PORTFOLIO_PT') ) {
			if (get_post_type()==TRX_ADDONS_CPT_PORTFOLIO_PT) {
				$cats = little_birdies_get_post_terms(', ', get_the_ID(), TRX_ADDONS_CPT_PORTFOLIO_TAXONOMY);
			}
		}
		if ( defined('TRX_ADDONS_CPT_COURSES_PT') ) {
			if (get_post_type()==TRX_ADDONS_CPT_COURSES_PT) {
				$cats = little_birdies_get_post_terms(', ', get_the_ID(), TRX_ADDONS_CPT_COURSES_TAXONOMY);
			}
		}
		if ( defined('TRX_ADDONS_CPT_DISHES_PT') ) {
			if (get_post_type()==TRX_ADDONS_CPT_DISHES_PT) {
				$cats = little_birdies_get_post_terms(', ', get_the_ID(), TRX_ADDONS_CPT_DISHES_TAXONOMY);
			}
		}
		return $cats;
	}
...
if ( !function_exists( 'little_birdies_trx_addons_list_header_styles' ) ) {
	//Handler of the add_filter( 'little_birdies_filter_list_header_styles', 'little_birdies_trx_addons_list_header_styles');
	function little_birdies_trx_addons_list_header_styles($list=array()) {
		if (little_birdies_exists_layouts()) {
			$layouts = little_birdies_get_list_posts(false, array(
...
if ( !function_exists( 'little_birdies_trx_addons_list_footer_styles' ) ) {
	//Handler of the add_filter( 'little_birdies_filter_list_footer_styles', 'little_birdies_trx_addons_list_footer_styles');
	function little_birdies_trx_addons_list_footer_styles($list=array()) {
		if (little_birdies_exists_layouts()) {
			$layouts = little_birdies_get_list_posts(false, array(
							'post_type' => TRX_ADDONS_CPT_LAYOUTS_PT,
							'meta_key' => 'trx_addons_layout_type',
...
if ( !function_exists( 'little_birdies_trx_addons_get_post_date_wrap' ) ) {
	//Handler of the add_filter( 'trx_addons_filter_get_post_date', 'little_birdies_trx_addons_get_post_date_wrap');
	function little_birdies_trx_addons_get_post_date_wrap($dt='') {
		return apply_filters('little_birdies_filter_get_post_date', $dt);
	}
}

// Show date of the courses
if ( !function_exists( 'little_birdies_trx_addons_get_post_date' ) ) {
	//Handler of the add_filter( 'little_birdies_filter_get_post_date', 'little_birdies_trx_addons_get_post_date');
	function little_birdies_trx_addons_get_post_date($dt='') {
...
if (!function_exists('little_birdies_trx_addons_allow_meta_box')) {
	//Handler of the add_filter( 'little_birdies_filter_allow_meta_box', 'little_birdies_trx_addons_allow_meta_box', 10, 2);
	function little_birdies_trx_addons_allow_meta_box($allow, $post_type) {
		return $allow
...
if (!function_exists('little_birdies_trx_addons_allow_theme_icons')) {
	//Handler of the add_filter( 'little_birdies_filter_allow_theme_icons', 'little_birdies_trx_addons_allow_theme_icons', 10, 2);
	function little_birdies_trx_addons_allow_theme_icons($allow, $post_type) {
		return $allow
...
if (!function_exists('little_birdies_trx_addons_meta_box_fields')) {
	//Handler of the add_filter( 'trx_addons_filter_meta_box_fields', 'little_birdies_trx_addons_meta_box_fields', 10, 2);
	function little_birdies_trx_addons_meta_box_fields($mb, $post_type) {
		if (defined('TRX_ADDONS_CPT_TEAM_PT') && $post_type==TRX_ADDONS_CPT_TEAM_PT) {
			$mb['email'] = array(
				"title" => esc_html__("E-mail",  'little-birdies'),
				"desc" => wp_kses_data( __("Team member's email", 'little-birdies') ),
				"std" => "",
				"details" => true,
				"type" => "text"
			);
...
if ( !function_exists( 'little_birdies_trx_addons_editor_load_scripts_admin' ) ) {
	//Handler of the add_action("admin_enqueue_scripts", 'little_birdies_trx_addons_editor_load_scripts_admin');
	function little_birdies_trx_addons_editor_load_scripts_admin() {
		// Add styles in the WP text editor
		add_editor_style( array(
							little_birdies_get_file_url('plugins/trx_addons/trx_addons.editor.css')
							)
						 );	
	}
}
...
if ( !function_exists( 'little_birdies_trx_addons_sc_atts' ) ) {
	//Handler of the add_filter( 'trx_addons_sc_atts', 'little_birdies_trx_addons_sc_atts', 10, 2);
	function little_birdies_trx_addons_sc_atts($atts, $sc) {
		...
		if (in_array($sc, array('trx_sc_action', 'trx_sc_blogger', 'trx_sc_courses', 'trx_sc_content', 'trx_sc_events', 'trx_sc_form', 'trx_sc_googlemap',
			...
			$atts['scheme'] = 'inherit';
        if (in_array($sc, array('trx_widget_slider')))
            $atts['text_block'] = '';
		return $atts;
	}
}
...
if ( !function_exists( 'little_birdies_trx_addons_sc_map' ) ) {
	//Handler of the add_filter( 'trx_addons_sc_map', 'little_birdies_trx_addons_sc_map', 10, 2);
	function little_birdies_trx_addons_sc_map($params, $sc) {
        ...
        if (in_array($sc, array('trx_widget_slider'))) {
            $params['params'][] = array(
                ...
                "heading" => esc_html__("Only text", 'little-birdies'),
                "description" => wp_kses_data( __("Only text in slider", 'little-birdies') ),
                "std" => 0,
                "value" => array(esc_html__("Only text in slider", 'little-birdies') => "1" ),
                "type" => "checkbox"
            );
        }
		return $params;
...
if ( !function_exists( 'little_birdies_trx_addons_sc_output' ) ) {
	//Handler of the add_filter( 'trx_addons_sc_output', 'little_birdies_trx_addons_sc_output', 10, 4);
	function little_birdies_trx_addons_sc_output($output, $sc, $atts, $content) {
		...
		} else if (in_array($sc, array('trx_widget_slider'))) {
            if (!empty($atts['text_block']) && (int) $atts['text_block']==1)
                $output = str_replace('sc_widget_slider', 'text_block sc_widget_slider', $output);
        }
		
		// Check if layouts components are showed
		if (in_array($sc, array('trx_sc_layouts_featured')))
			little_birdies_sc_layouts_showed('featured', is_singular() && in_array(get_post_type(), array('post', 'page')) && has_post_thumbnail());
			...
			little_birdies_sc_layouts_showed('cart', true);
		else if (in_array($sc, array('trx_sc_layouts_logo')))
			little_birdies_sc_layouts_showed('logo', true);
		else if (in_array($sc, array('trx_sc_layouts_menu')))
			little_birdies_sc_layouts_showed('menu', true);
		else if (in_array($sc, array('trx_sc_layouts_search')))
			little_birdies_sc_layouts_showed('search', true);
...
if ( !function_exists( 'little_birdies_trx_addons_slider_title' ) ) {
	//Handler of the add_filter( 'trx_addons_filter_slider_title',	'little_birdies_trx_addons_slider_title', 10, 2 );
	function little_birdies_trx_addons_slider_title($title, $data) {
		$title = '';
		if (!empty($data['title'])) 
...
if (!function_exists('little_birdies_sc_layouts_showed')) {
	function little_birdies_sc_layouts_showed($name, $val=null) {
		if ($val!==null)
			return little_birdies_storage_set_array('sc_layouts_components', $name, $val);
		else
			return little_birdies_storage_get_array('sc_layouts_components', $name) != '';
	}
}

// Return image size multiplier
if (!function_exists('little_birdies_get_retina_multiplier')) {
	function little_birdies_get_retina_multiplier($force_retina=0) {
		static $mult = 0;
...
if (!function_exists('little_birdies_build_slider_layout')) {
	function little_birdies_build_slider_layout($args) {
...
if ( !function_exists( 'little_birdies_trx_addons_featured_image' ) ) {
	//Handler of the add_filter( 'trx_addons_filter_featured_image', 'little_birdies_trx_addons_featured_image', 10, 2);
	function little_birdies_trx_addons_featured_image($processed=false, $args=array()) {
		$args['show_no_image'] = true;
		$args['singular'] = false;
		$args['hover'] = little_birdies_get_theme_option('image_hover');
		little_birdies_show_post_featured($args);
		return true;
	}
}

// Return theme specific 'no-image' picture
if ( !function_exists( 'little_birdies_trx_addons_no_image' ) ) {
	//Handler of the add_filter( 'trx_addons_filter_no_image', 'little_birdies_trx_addons_no_image');
	function little_birdies_trx_addons_no_image($no_image='') {
		return little_birdies_get_no_image($no_image);
	}
}

// Return theme-specific icons
if ( !function_exists( 'little_birdies_trx_addons_get_list_icons' ) ) {
	//Handler of the add_filter( 'trx_addons_filter_get_list_icons', 'little_birdies_trx_addons_get_list_icons', 10, 2 );
	function little_birdies_trx_addons_get_list_icons($list, $prepend_inherit) {
		return little_birdies_get_list_icons($prepend_inherit);
	}
}

// Return links to the social profiles
if (!function_exists('little_birdies_get_socials_links')) {
	function little_birdies_get_socials_links($style='icons') {
...
if (!function_exists('little_birdies_get_share_links')) {
	function little_birdies_get_share_links($args=array()) {
...
if (!function_exists('little_birdies_show_share_links')) {
	function little_birdies_show_share_links($args=array()) {
...
if (!function_exists('little_birdies_get_category_image')) {
	function little_birdies_get_category_image($term_id=0) {
...
if (!function_exists('little_birdies_get_category_icon')) {
	function little_birdies_get_category_icon($term_id=0) {
...
if (!function_exists('little_birdies_get_post_counters')) {
	function little_birdies_get_post_counters($counters='views') {
...
if (!function_exists('little_birdies_get_list_animations_in')) {
	function little_birdies_get_list_animations_in() {
...
if (!function_exists('little_birdies_get_animation_classes')) {
	function little_birdies_get_animation_classes($animation, $speed='normal', $loop='none') {
...
if (!function_exists('little_birdies_get_comment_counters')) {
	function little_birdies_get_comment_counters($counters = 'likes') {
...
if (!function_exists('little_birdies_show_comment_counters')) {
	function little_birdies_show_comment_counters($counters = 'likes') {
...
if (!function_exists('little_birdies_trx_addons_query_sort_order')) {
	//Handler of the add_filter('little_birdies_filter_query_sort_order', 'little_birdies_trx_addons_query_sort_order', 10, 3);
	function little_birdies_trx_addons_query_sort_order($q=array(), $orderby='date', $order='desc') {
		if ($orderby == 'views') {
...
if ( !function_exists( 'little_birdies_trx_addons_theme_logo' ) ) {
	//Handler of the add_filter( 'trx_addons_filter_theme_logo', 'little_birdies_trx_addons_theme_logo');
	function little_birdies_trx_addons_theme_logo($logo) {
		return little_birdies_get_logo_image();
	}
}

// Return theme-specific post meta to the plugin
if ( !function_exists( 'little_birdies_trx_addons_post_meta' ) ) {
	//Handler of the add_filter( 'trx_addons_filter_post_meta',	'little_birdies_trx_addons_post_meta', 10, 2);
	function little_birdies_trx_addons_post_meta($meta, $args=array()) {
		return little_birdies_show_post_meta($args);
	}
}
	
// Redirect action 'get_mobile_menu' to the plugin
// Return stored items as mobile menu
if ( !function_exists( 'little_birdies_trx_addons_get_mobile_menu' ) ) {
	//Handler of the add_filter("little_birdies_filter_get_mobile_menu", 'little_birdies_trx_addons_get_mobile_menu');
	function little_birdies_trx_addons_get_mobile_menu($menu) {
		return apply_filters('trx_addons_filter_get_mobile_menu', $menu);
	}
}

// Redirect action 'login' to the plugin
if (!function_exists('little_birdies_trx_addons_action_login')) {
	//Handler of the add_action( 'little_birdies_action_login',		'little_birdies_trx_addons_action_login', 10, 2);
	function little_birdies_trx_addons_action_login($link_text='', $link_title='') {
		do_action( 'trx_addons_action_login', $link_text, $link_title );
	}
}

// Redirect action 'search' to the plugin
if (!function_exists('little_birdies_trx_addons_action_search')) {
	//Handler of the add_action( 'little_birdies_action_search', 'little_birdies_trx_addons_action_search', 10, 3);
	function little_birdies_trx_addons_action_search($style, $class, $ajax) {
		do_action( 'trx_addons_action_search', $style, $class, $ajax );
	}
}

// Redirect action 'breadcrumbs' to the plugin
if (!function_exists('little_birdies_trx_addons_action_breadcrumbs')) {
	//Handler of the add_action( 'little_birdies_action_breadcrumbs',	'little_birdies_trx_addons_action_breadcrumbs');
	function little_birdies_trx_addons_action_breadcrumbs() {
		do_action( 'trx_addons_action_breadcrumbs' );
	}
}

// Redirect action 'show_layout' to the plugin
if (!function_exists('little_birdies_trx_addons_action_show_layout')) {
	//Handler of the add_action( 'little_birdies_action_show_layout', 'little_birdies_trx_addons_action_show_layout', 10, 1);
	function little_birdies_trx_addons_action_show_layout($layout_id='') {
		do_action( 'trx_addons_action_show_layout', $layout_id );
	}
}

// Redirect filter 'get_blog_title' to the plugin
if ( !function_exists( 'little_birdies_trx_addons_get_blog_title' ) ) {
	//Handler of the add_filter( 'little_birdies_filter_get_blog_title', 'little_birdies_trx_addons_get_blog_title');
	function little_birdies_trx_addons_get_blog_title($title='') {
		return apply_filters('trx_addons_filter_get_blog_title', $title);
	}
}

// Redirect filter 'prepare_css' to the plugin
if (!function_exists('little_birdies_trx_addons_prepare_css')) {
	//Handler of the add_filter( 'little_birdies_filter_prepare_css',	'little_birdies_trx_addons_prepare_css', 10, 2);
	function little_birdies_trx_addons_prepare_css($css='', $remove_spaces=true) {
		return apply_filters( 'trx_addons_filter_prepare_css', $css, $remove_spaces );
	}
}

// Redirect filter 'prepare_js' to the plugin
if (!function_exists('little_birdies_trx_addons_prepare_js')) {
	//Handler of the add_filter( 'little_birdies_filter_prepare_js',	'little_birdies_trx_addons_prepare_js', 10, 2);
	function little_birdies_trx_addons_prepare_js($js='', $remove_spaces=true) {
...
if (!function_exists('little_birdies_trx_addons_get_css')) {
	//Handler of the add_filter('little_birdies_filter_get_css', 'little_birdies_trx_addons_get_css', 10, 4);
	function little_birdies_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.trx_addons_dropcap.trx_addons_dropcap_style_4 {
    color: {$colors['alter_link']};
}
...
.scheme_darks ul[class*="trx_addons_list"]>li:before {

    color: {$colors['alter_link']};
}
.scheme_darks ul[class*="trx_addons_list_success"]>li:after {
    background-color: {$colors['bg_color']};
}
...
.post_format-post-format-quote blockquote b,
blockquote.trx_addons_blockquote_style_1 b {
	color: {$colors['bg_color']};
}
.post_format-post-format-quote blockquote a,
.post_format-post-format-quote blockquote cite,
blockquote.trx_addons_blockquote_style_1 a,
blockquote.trx_addons_blockquote_style_1 cite {
	color: {$colors['text_link']};
}
.post_format-post-format-quote blockquote a:hover,
...
.sc_item_button a.sc_button_hover_style_yellow:not(.sc_button_bg_image):hover {
	color:{$colors['inverse_text']} !important;
...
.vc_row-has-fill .sc_countdown_default .sc_countdown_item {
    background-color: {$colors['bg_color']};
}
...
.sc_form .sc_form_field textarea:hover {
	color: {$colors['text']};
	border-top-color: {$colors['alter_bd_color']}  !important;
	background-color: {$colors['alter_bg_color']};
}
...
.vc_row-has-fill .sc_form .sc_form_field input[type="text"],
.vc_row-has-fill .sc_form .sc_form_field input[type="password"],
.vc_row-has-fill .sc_form .sc_form_field input[type="email"],
.vc_row-has-fill .sc_form .sc_form_field input[type="number"],
.vc_row-has-fill .sc_form .sc_form_field input[type="tel"],
.vc_row-has-fill .sc_form .sc_form_field input[type="search"],
.vc_row-has-fill .sc_form .sc_form_field textarea {
	background-color: {$colors['bg_color']};
	border-color: {$colors['bg_color']} !important;
}

.footer_wrap .mc4wp-form .mc4wp-form-fields input[type="email"]:hover,
.vc_row-has-fill .sc_form .sc_form_field input[type="text"]:hover,
.vc_row-has-fill .sc_form .sc_form_field input[type="password"]:hover,
.vc_row-has-fill .sc_form .sc_form_field input[type="email"]:hover,
.vc_row-has-fill .sc_form .sc_form_field input[type="number"]:hover,
.vc_row-has-fill .sc_form .sc_form_field input[type="tel"]:hover,
.vc_row-has-fill .sc_form .sc_form_field input[type="search"]:hover,
.vc_row-has-fill .sc_form .sc_form_field textarea:hover{
	background-color: {$colors['bg_color']};
	border-top-color: {$colors['alter_bd_color']} !important;
}

.footer_wrap .mc4wp-form .mc4wp-form-fields input[type="email"]:focus,
.vc_row-has-fill .sc_form .sc_form_field input[type="text"]:focus,
.vc_row-has-fill .sc_form .sc_form_field input[type="password"]:focus,
.vc_row-has-fill .sc_form .sc_form_field input[type="email"]:focus,
.vc_row-has-fill .sc_form .sc_form_field input[type="number"]:focus,
.vc_row-has-fill .sc_form .sc_form_field input[type="tel"]:focus,
.vc_row-has-fill .sc_form .sc_form_field input[type="search"]:focus,
.vc_row-has-fill .sc_form .sc_form_field textarea:focus {
	background-color: {$colors['bg_color']};
	border-top-color: {$colors['text_link']} !important;
}
...
.sc_price_info .sc_price_title:hover,
...
.sc_services_color div[class*="trx_addons_column"]:nth-child(6n+2) .sc_services_item_icon {
    color: {$colors['inverse_text']};
	border-color: {$colors['alter_link']};
	background-color: {$colors['alter_link']};
}
.sc_services_color div[class*="trx_addons_column"]:nth-child(6n+3) .sc_services_item_icon {
    color: {$colors['inverse_text']};
...
.sc_services_color div[class*="trx_addons_column"]:nth-child(6n+5) .sc_services_item_icon {
    color: {$colors['inverse_text']};
	border-color: {$colors['alter_text']};
	background-color: {$colors['alter_text']};
}
.sc_services_color div[class*="trx_addons_column"]:nth-child(6n+6) .sc_services_item_icon {
    color: {$colors['inverse_text']};
	border-color: {$colors['alter_light']};
	background-color: {$colors['alter_light']};
}
.sc_services_color .sc_services_item:hover .sc_services_item_icon {
...
.scheme_self.footer_wrap > .sc_layouts_row_type_narrow + .vc_row:not(.sc_layouts_row_type_narrow) .socials_wrap .social_item a {
	color: {$colors['text_hover']};
	background-color: {$colors['bg_color']};
}
.scheme_self.footer_wrap > .sc_layouts_row_type_narrow + .vc_row:not(.sc_layouts_row_type_narrow) .socials_wrap .social_item a:hover {
	color: {$colors['bg_color']};
	background-color: {$colors['alter_light']};
}
...
body .littlebird .esg-navigationbutton:hover,
body .littlebird .esg-navigationbutton.selected {
    background-color: {$colors['text_link']};
}
